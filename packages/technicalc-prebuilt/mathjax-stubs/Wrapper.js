...
/*
Taken directly from MathJax JS output

Code modifications marked with CUSTOM CODE BEGIN/END comments
*/
...
/* CUSTOM CODE BEGIN */
var Wrapper_js_1 = require("mathjax-full/js/output/common/Wrapper.js");
...
var SVGWrapper = (function (_super) {
  ...
  SVGWrapper.prototype.placeChar = function (n, x, y, parent, variant) {
    ...
    if (data.p === 0) {
      ...
      try {
        for (
          var _c = __values(this.unicodeChars(data.c)), _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
          var n_1 = _d.value;
