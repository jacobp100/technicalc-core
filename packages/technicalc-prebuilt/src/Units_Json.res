...
let json = [
  ...
  },
  {
    ...
    data: [
      [
        {
          units: [{prefix: Unit, unit: Mile, power: 1}, {prefix: Unit, unit: Hour, power: -1}],
          primary: true,
        },
        {
          units: [{prefix: Kilo, unit: Meter, power: 1}, {prefix: Unit, unit: Hour, power: -1}],
          primary: true,
        },
      ],
      [
        {
          units: [{prefix: Unit, unit: Meter, power: 1}, {prefix: Unit, unit: Second, power: -1}],
          primary: true,
        },
      ],
  ...
  },
  {
    ...
    data: [
      ...
      [
        {
          units: [{prefix: Unit, unit: Watt, power: 1}, {prefix: Unit, unit: Hour, power: 1}],
          primary: true,
        },
        {
          units: [{prefix: Kilo, unit: Watt, power: 1}, {prefix: Unit, unit: Hour, power: 1}],
          primary: true,
        },
      ],
