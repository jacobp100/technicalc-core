...
%%private(
  let resizeTable = (
    ...
    let toCells = Belt.Array.makeBy(toRows * toColumns, i => {
    ...
    let selectionIndex = Belt.Array.getIndexBy(cellRanges, ((start, end)) => {
    ...
    | Some(selectionIndex) =>
      ...
      let previousCellElements = Belt.Array.reduceWithIndex(toCells, 0, (accum, cells, i) => {
